              ...
              {!! Form::open(['action' => 
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    {{Form::text('description1', $slider->description1, ['class'=> 'form-control','id'=> 'exampleInputEmail1', 'placeholder' =>'Enter description'])}}
                  </div>
                  <div class="form-group">
                    {{-- <label for="exampleInputEmail1">Product name</label>
                    <input type="text" name="product_name" class="form-control" id="exampleInputEmail1" placeholder="Enter product name"> --}}
                    {{Form::label('','Description 2', ['for'=> 'exampleInputEmail1'])}}
                    {{Form::text('description2', $slider->description2, ['class'=> 'form-control','id'=> 'exampleInputEmail1', 'placeholder' =>'Enter description'])}}
                  </div>
