                  ...
                  <tbody>
                    @foreach ($products as $product)
                      <tr>
                        ...
                        <td>
                          @if ($product->status == 1)
                            <a href="{{url('/unactivate_product/'. $product->id)}}" class="btn btn-success">Ẩn</a>
                          @else
                            <a href="{{url('/activate_product/'. $product->id)}}" class="btn btn-warning">Hiện</a>
                          @endif
...
@section('scripts')
    ...
    bootbox.confirm("Bạn thật sự muốn xoá sản phẩm này ?", function(confirmed){
        if (confirmed){
